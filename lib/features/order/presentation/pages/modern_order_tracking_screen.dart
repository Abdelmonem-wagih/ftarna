...
class ModernOrderTrackingScreen extends StatefulWidget {
  final String orderId;

  const ModernOrderTrackingScreen({
    super.key,
    required this.orderId,
  });

  @override
  State<ModernOrderTrackingScreen> createState() =>
      _ModernOrderTrackingScreenState();
}

class _ModernOrderTrackingScreenState extends State<ModernOrderTrackingScreen>
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (info.buildingName != null || info.floor != null)
                  Text(
                    '${info.buildingName ?? ''}${info.floor != null ? ', Floor ${info.floor}' : ''}${info.apartment != null ? ', Apt ${info.apartment}' : ''}',
                    style: TextStyle(
                      color: AppTheme.textSecondary,
                      fontSize: 13,
                    ),
